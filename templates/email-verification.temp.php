...
$sm_mail_subject = 'Willkommen bei steuermachen! Bestätigen Sie bitte Ihre E-Mail-Adresse';
															...
															<td>
																<div style="font-family: Arial, sans-serif">
																	<div class="txtTinyMce-wrapper" style="font-size: 14px; font-family: Arial, \'Helvetica Neue\', Helvetica, sans-serif; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2;">
																		...
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		Klicken Sie auf den untenstehenden Link, um Ihren Account zu aktivieren:&nbsp;<br>
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0;"><a href="' . $sm_verification_link . '" target="_blank" style="text-decoration: underline; color: #ff6138;" rel="noopener">' . $sm_verification_link . '</a></p>
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td>
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper" style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
