 ...
 * Template Details
 * 
 * Name: Steuererklärung Anrechtung (Rechnung)
 * 
 * Attachments:
 * ! - Rechnung (steuererklaerung-erstberatung [PDF Template])
 * * The invoice will be issed by the lawyer (this feature has to be
		...
		<tbody>
			<tr>
				<td>
															...
															<td>
																<div style="font-family: Arial, sans-serif">
																	<div style="font-size: 14px; font-family: Arial, \'Helvetica Neue\', Helvetica, sans-serif; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2;">
																		...
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0;">Ihre Beauftragung wurde fertig gestellt.</p>
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0;">Beigefügt übersenden wir Ihnen die Rechnung mit der Rechnungsnummer: <strong>' . $sm_invoice_number . '</strong> mit der Bitte um Ausgleich.</p>
																		<p style="margin: 0;">Bitte beachten Sie, dass der Betrag sofort zur Zahlung fällig ist.</p>
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0;">Die Rechnung sowie sämtliche Informationen zu Ihrem Auftrag können Sie auch mit Ihrem Profil in der steuermachen-App jederzeit aufrufen.</p>
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0;"><strong>Hinweis: Nehmen Sie die Rechnung bitte in Ihren Steuerunterlagen auf, da unter bestimmten Voraussetzungen ein steuerrechtlicher Abzug erfolgen kann. Informieren Sie dazu Ihren steuerrechtlichen Berater. Die Rechnung finden Sie auch in Ihrem Profil.</strong></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td>
																<div style="font-family: sans-serif">
																	<div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
																		...
																		<p style="margin: 0;"><a href="www.steuermachen.de" target="_blank" style="text-decoration: underline; color: #ff6138;" rel="noopener">www.steuermachen.de</a></p>
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0;">GDF GmbH<br>Kaiserstraße 23<br>90403 Nürnberg<br>Fon: 0911-80190910</p>
																		<p style="margin: 0;">E-Mail: <a href="mailto:dialog@steuermachen.de" target="_self" title="dialog@steuermachen.de" style="color: #ff6138;">dialog@steuermachen.de</a></p>
					...
					<table class="row row-3" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #71d64a;">
						<tbody>
							<tr>
								<td>
