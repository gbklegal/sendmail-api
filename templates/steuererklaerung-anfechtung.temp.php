 ...
 * Template Details
 * 
 * Name: Steuererklärung Anfechtung
 * 
 * Attachments:
 * - Checkliste
 * - AGB
...
$sm_mail_attachments[] = WP_CONTENT_DIR . '/uploads/2022/02/steuermachenCheckliste.pdf';
$sm_mail_attachments[] = WP_CONTENT_DIR . '/uploads/2021/01/AGBSteuerkanzleiGussmann012021.pdf';
															...
															<td>
																<div style="font-family: Arial, sans-serif">
																	<div style="font-size: 14px; font-family: Arial, \'Helvetica Neue\', Helvetica, sans-serif; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2;">
																		...
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0; margin-left: 40px;"><strong>&nbsp;&gt; Ihre Checkliste und die Vollmacht für Ihre Steuerkanzlei.</strong></p>
																		<br>
																		<p style="margin: 0;">Sie sind fast am Ziel! Soweit noch nicht geschehen, übersenden Sie uns bitte umgehend die nachfolgenden Unterlagen:</p>
																		<p style="margin: 0; margin-left: 40px; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0; margin-left: 40px;">➣ <strong>Steuerbescheid</strong> der angefochten werden soll (letzter Einkommensteuerbescheid)</p>
																		<p style="margin: 0; margin-left: 40px;"><br>➣&nbsp;<strong>Einspruchsentscheidung </strong>des Finanzamtes</p>
																		<p style="margin: 0; margin-left: 40px; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0; margin-left: 40px;">➣&nbsp;Kopie des Versicherungsscheins bzw. Benennung der Rechtsschutzversicherung (alternativ kann auch die letzte Beitragsrechnung oder ein Nachtrag der Versicherung in Kopie übersendet werden)</p>
																		<p style="margin: 0; margin-left: 40px;"><br>➣ Unterzeichnete Vollmacht&nbsp;</p>
																		<p style="margin: 0; margin-left: 40px;"><br>➣ Sonstige Belege und aus Ihrer Sicht relevante Mitteilungen</p>
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		...
																		<p style="margin: 0; margin-left: 40px; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0; margin-left: 40px;">steuermachen<br>Kaiserstr. 23<br>90403 Nürnberg<br>Telefax: 0911 - 801 90 911</p>
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0;"><strong>Damit Ihre Bestellung noch schneller bearbeitet wird, senden Sie die Unterlagen </strong><strong>vorzugsweise per E-Mail. </strong></p>
																		<p style="margin: 0; margin-left: 40px; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		...
																		<p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0;">Die Annahme des Mandates durch die Steuerkanzlei bleibt bis zur Prüfung der Unterlagen ausdrücklich vorbehalten. Wir werden Sie insoweit weiter unterrichten und stehen für Rückfragen gerne zur Verfügung.</p>
																	</div>
																</div>
															</td>
														</tr>
